...
import { Play, Chrome, ChevronDown, RefreshCw, Users } from 'lucide-react'
import {
  DropdownMenu,
  DropdownMenuContent,
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  className={`flex-1 text-white ${browserMode === 'single' ? 'bg-green-600 hover:bg-green-700 ' : ''}`}
                ...
                <Button
                  ...
                  className={`flex-1 text-white ${browserMode === 'multiple' ? 'bg-green-600 hover:bg-green-700' : ''}`}
            ...
            {loadingAccounts ? (
              <div className="h-48 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">Loading accounts...</p>
                </div>
              </div>
            ) : accounts.length === 0 ? (
              ...
              <>
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                  <div className="p-4 rounded-lg border-2 border-gray-200 dark:border-gray-700 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900">
                  ...
                  <div className="p-4 rounded-lg border-2 border-gray-200 dark:border-gray-700 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-xs font-medium text-gray-600 dark:text-gray-400">Idle</span>
                    </div>
                  ...
                  <div className="p-4 rounded-lg border-2 border-gray-200 dark:border-gray-700 bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20">
                    <div className="flex items-center gap-2 mb-2">
                  ...
                  <div className="p-4 rounded-lg border-2 border-gray-200 dark:border-gray-700 bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900/20 dark:to-red-800/20">
                    <div className="flex items-center gap-2 mb-2">
                  ...
                  <div className="p-4 rounded-lg border-2 border-gray-200 dark:border-gray-700 bg-gradient-to-br from-yellow-50 to-yellow-100 dark:from-yellow-900/20 dark:to-yellow-800/20">
                    <div className="flex items-center gap-2 mb-2">
                ...
                <div className="mt-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                    {Array.from(new Set(accounts.filter(a => a.status === 'IDLE').map(a => a.country).filter(Boolean))).map(country => (
                      <div key={country} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                  ...
                  <div className="mt-4 grid grid-cols-2 md:grid-cols-4 gap-2">
                    {Array.from(new Set(accounts.filter(a => a.status === 'IDLE' && a.hasCookies).map(a => a.country).filter(Boolean))).map(country => (
                      <div key={country} className="flex items-center justify-between p-2 bg-white dark:bg-blue-800/30 rounded border border-blue-300 dark:border-blue-700">
          ...
          <CardContent>
            {loading ? (
              <div className="h-48 flex items-center justify-center">
                <div className="text-center">
                  <div className="mx-auto h-8 w-8 animate-spin rounded-full border-4 border-gray-300 border-t-blue-600" />
                  <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">Loading nodes...</p>
                </div>
              </div>
            ) : nodes.length === 0 ? (
              <div className="text-center py-10 text-gray-600 dark:text-gray-400">
          ...
          <CardContent>
            {loadingBrowsers ? (
              <div className="h-48 flex items-center justify-center">
                <div className="text-center">
                  <div className="mx-auto h-8 w-8 animate-spin rounded-full border-4 border-gray-300 border-t-blue-600" />
                  <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">Loading browsers...</p>
                </div>
              </div>
            ) : browsers.length === 0 ? (
              <div className="text-center py-10 text-gray-600 dark:text-gray-400">
              ...
              <>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                  {browsers.map(browser => (
                    <div 
                      key={browser.id} 
                      className="flex flex-col p-3 rounded-lg border border-gray-200 dark:border-gray-700 bg-card hover:shadow-md transition-shadow"
                    >
                ...
                <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-600 dark:text-gray-400">Total Browsers:</span>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-2 mt-3">
                      {Array.from(new Set(browsers.map(b => b.country))).map(country => (
                        <div key={country} className="flex items-center justify-between p-2 bg-gray-50 dark:bg-gray-800 rounded">
                          <span className="text-xs text-gray-600 dark:text-gray-400">{country.toUpperCase()}:</span>
